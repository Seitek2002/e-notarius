<template>
  <div>
    <div class="info__form">
      ...
      <p
        v-if="end && isActiveRadio === 1"
        class="passportConfirm"
      >
        <SuccessSmallIcon/>
        Данные действительны в базе данных
        <br>
        "Тундук"
      </p>
      <p
...
import CheckboxCheckedIcon from '@/components/global/Info/Icons/CheckboxCheckedIcon.vue'
import PersonCheckIcon from '@/components/global/Info/Icons/PersonCheckIcon.vue'
import PersonFilledIcon from '@/components/global/Info/Icons/PersonFilledIcon.vue'
...
const fetchUsers = () => {
  ...
  setTimeout(() => {
    ...
    store.commit('setChoosenApplicant', `${surname.value} ${name.value} ${lastname.value}`)
