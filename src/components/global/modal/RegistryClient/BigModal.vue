<template>
    <div class="big_modal">
        ...
        <form
            @submit.prevent="store.state.registryClientBigModal = false; deleteData(); store.state.registryClientMiniModal = true; examination = true"
            ...
            <Suptitle v-show="examination" text="Документ, удостоверяющий личность" />
            <div v-show="examination" class="big_modal__form--wrapper">
            ...
            <Suptitle v-show="examination" text="Адрес прописки (регистрации)" />
            <div v-show="examination" class="big_modal-content">
                <div class="big_modal__form--wrapper">
            ...
            <div class="big_modal-btns">
                <button v-show="checked == false" class="big_modal-btn-first">
                    ...
                    <div v-show="examination" class="big_modal-flex" style="align-items: start; margin: 20px 0 30px; ">
                ...
                <Suptitle v-show="examination" text="Контактные данные" />
                    <div v-show="examination" class="big_modal__form--wrapper">
