<template>
  <section class="registry_client">
    ...
    <div class="registry_client__adaptive">
      <div class="registry_client__left">
        <label class="tooltip">
      ...
      <div class="registry_client__right">
    ...
    <div ref="container" class="registry_client-table">
      <table>
        <thead>
          <tr>
            <th>
    ...
    <button class="registry_client-excel another">
          Экспортировать в Exсel
          <ExcelIcon />
        </button>
