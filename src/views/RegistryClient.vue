    ...
    <section class="registryClient">
        ...
        <div class="registryClient-head">
            <div class="registryClient-info">
                ...
                <button class="registryClient-excel">Экспортировать в Exсel
                    <ExcelIcon />
                </button>
            </div>
            <div class="registryClient-info">
...
onMounted(() => {
    (() => emits('islam', 'Реестр пользователей'))()
})
