      ...
      <table>
        <thead>
          <tr>
            ...
            <th>
              <Dropdown title="Дата рождения" :option="[]" />
            </th>
            <th>
              <Dropdown title="Мобильный телефон" :option="[]" />
            </th>
            <th>
              <Dropdown title="E-mail" :option="[]" />
            </th>
          </tr>
        </thead>
...
onMounted(() => {
  (() =>
    emits("handleChangeTitle", "Реестр должностных лиц загранучреждений"))();
});
