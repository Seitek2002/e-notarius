<template>
  <section class="order-list">
    <div class="order-list__top">
      ...
      <Btn title="Создать действия" bg="#1BAA75" @click="router.push('/info-notarius')" />
    </div>
    <div class="order__adaptive">
      <div class="order__left">
        <label class="tooltip">
          ...
          <input type="checkbox" />
          <span>Таблицу можно скролить по<br />
...
onMounted(() => {
  (() => emits("handleChangeTitle", "Реестр наследственных дел"))();
});
