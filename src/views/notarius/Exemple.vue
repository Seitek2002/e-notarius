<template>
  <section class="exemple">
    <div class="exemple-wrapper">
      ...
      <div class="exemple__adaptive">
        <div class="exemple__left">
          <label class="tooltip">
        ...
        <div class="exemple__right">
          <svg @click="handleScrollLeftt" width="40" height="40" viewBox="0 0 40 40" fill="none"
            xmlns="http://www.w3.org/2000/svg">
          ...
          <svg @click="handleScrollRightt" width="40" height="40" viewBox="0 0 40 40" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <rect x="0.5" y="0.5" width="39" height="39" fill="white" />
        ...
        <table>
          ...
          <tbody>
            <tr v-for="(_, i) in paginatedItems" :key="i">
              <td>01238</td>
              <td>Договор купли-продажи квартиры(жилого дома)</td>
    ...
    <div class="exemple-wrapper">
      <div class="exemple-head">
        <h2 class="exemple-title">Ручные шаблоны</h2>
        <button class="exemple-btn">Создать новый шаблон</button>
      </div>
      <div class="exemple__adaptive">
        <div class="exemple__left">
          <label class="tooltip">
