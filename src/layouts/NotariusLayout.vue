<template>
  <div class="app-notarius-layout">
    <section
      :class="store.state.notariusSidebar ? 'sidebar active' : 'sidebar'"
    >
        ...
        >
          ...
          <div @click="secondIndex = !secondIndex">
            <div :class="secondIndex ? 'sidebar-item active' : 'sidebar-item'">
              ...
              <up
                v-show="!store.state.notariusSidebar"
          ...
          <div v-show="secondIndex && !store.state.notariusSidebar">
            <div
              ...
              :class="
                thirdIndex === i
                  ? ' sidebar-item sidebar-mini-item active'
                  : 'sidebar-item sidebar-mini-item'
              "
              @click="
                thirdIndex = i;
                firstIndex = null;
